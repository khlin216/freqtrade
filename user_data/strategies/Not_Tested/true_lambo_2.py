...
class true_lambo(IStrategy):
    ...
    high_offset = DecimalParameter(
        0.85, 1.1, default=sell_params['high_offset'], space='sell', optimize=True)
    high_offset_2 = DecimalParameter(
        0.85, 1.5, default=sell_params['high_offset_2'], space='sell', optimize=True)

    # Trailing params

    # hard stoploss profit
    pHSL = DecimalParameter(-0.10, -0.040, default=-0.08, decimals=3,
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['vwap_width'] = (
            (dataframe['vwap_upperband'] - dataframe['vwap_lowerband']) / dataframe['vwap_middleband']) * 100
        ...
        dataframe['ema_vwap_diff_50'] = (
            (dataframe['ema_50'] - dataframe['vwap_lowerband']) / dataframe['ema_50'])
